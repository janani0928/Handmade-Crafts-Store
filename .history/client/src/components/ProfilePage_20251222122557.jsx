    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <div style={{ width: "250px", backgroundColor: "#f5f5f5", padding: "20px" }}>
        ...
        <div style={{ marginTop: "30px" }}>
          <div onClick={() => navigate("/my-orders")} style={{ cursor: "pointer", fontWeight: "bold" }}>
            MY ORDERS
          </div>
      ...
      <div style={{ flex: 1, padding: "20px" }}>
        ...
        {activeTab === "addresses" && (
          <>
            <h2 onClick={() => navigate("/my-orders")}>Manage Addresses</h2>
            <p>Here you can add, edit, or remove addresses.</p>
            <span onClick={() => navigate("/my-orders")}></span>
          </>
        )}
      </div>
    </div>
