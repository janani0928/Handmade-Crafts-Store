  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.sidebar}>
        <h3 style={{ marginBottom: 20,marginTop:15,fontSize:25, }} >Hello,<span style={{color:"#ff4081",}}>{user.firstName}</span> </h3>
        ...
        <div style={{ marginTop: 20, }}>
          <b style={{color:"#00796b",fontWeight:900,fontSize:18}}>ACCOUNT SETTINGS</b>
      ...
      <div style={styles.content}>
        ...
        {activeTab === "profile" && (
          <>
            <h2 style={{color:"#00796b",fontWeight:900,fontSize:28,marginBottom:20}}>
        ...
        {activeTab === "address" && (
          <>
            <h2 style={{color:"#00796b",fontWeight:900,fontSize:28,marginBottom:20}}>Manage Addresses</h2>
