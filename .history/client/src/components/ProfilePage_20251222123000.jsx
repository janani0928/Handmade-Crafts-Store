        ...
        {activeTab === "addresses" && (
          <>
                ...
                >
                  ...
                  {isSelected && (
                    <div style={{ display: "flex", gap: "10px" }}>
                      <button onClick={(e) => { e.stopPropagation(); goNext(); }}>DELIVER HERE</button>
                      <span
                        onClick={(e) => {
                          e.stopPropagation();
            ...
            <div style={{ marginTop: "30px", borderTop: "1px solid #ccc", paddingTop: "20px" }}>
              <h3 style={{ color: "#00796b", fontWeight: 700 }}>PRICE DETAILS</h3>
              ...
              {totalSavings > 0 && (
                <p style={{ color: "#ff4081" }}>You saved ₹{formatPrice(totalSavings)} on this order</p>
              )}
            </div>
          </>
        )}
